...
export const loader = async ({ request }) => {
  ...
  const currentPlan = validPlan(searchParams.get("currentPlan"));

  return { plans: PLANS, currentPlan };
};
      ...
      <s-section heading="Frequently Asked Questions">
        <s-stack direction="block" gap="base">
          ...
          <div style={faqStyle}>
            ...
            <p style={{ color: "#6d7175", margin: 0, fontSize: "14px" }}>
              Upgrading to the Starter plan unlocks the Bold Hero and Carousel Spotlight templates. Upgrading to the Pro plan unlocks all templates (including Masonry Gallery and Compact List) for complete storefront customization.
            </p>
          </div>
        </s-stack>
      </s-section>
